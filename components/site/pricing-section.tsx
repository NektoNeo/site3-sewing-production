...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-16 md:scroll-mt-24 bg-black">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold text-white">Стоимость услуг</h2>
            <p className="text-lg text-mist-300 font-medium">{PRICING_HEADER_NOTE}</p>
          </div>
